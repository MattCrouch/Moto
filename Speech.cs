        ...
        private readonly Dictionary<string, WhatSaid> startScreenPhrases = new Dictionary<string, WhatSaid>
            {
                ...
                { "Play Instruments", new WhatSaid { Verb = Verbs.Instrument} },
                { "Play an Instrument", new WhatSaid { Verb = Verbs.Instrument} },
                { "Instruments", new WhatSaid { Verb = Verbs.Instrument} },
                { "Play Guitar", new WhatSaid { Verb = Verbs.Instrument } },
                { "Play Drums", new WhatSaid { Verb = Verbs.Instrument } },
